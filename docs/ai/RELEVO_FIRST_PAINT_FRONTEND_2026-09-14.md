...
Hubo un intento de push directo del JS que quedó a medias en esta rama.
**No mergear esta rama hasta que el JS esté completo y testeado.**
Quien recoja el relevo: aplicar el cambio arriba sobre `main` limpio.
