"""Liga de Maestros - scoring helpers.

This module owns the canonical implementations. The root ``scoring.py`` shim
re-exports these symbols so existing callers do not break during the cleanup
